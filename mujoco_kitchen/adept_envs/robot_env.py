...
from mujoco_kitchen.adept_envs import mujoco_env
from mujoco_kitchen.adept_envs.base_robot import BaseRobot
from mujoco_kitchen.adept_envs.utils.configurable import import_class_from_path
from mujoco_kitchen.adept_envs.utils.constants import MODELS_PATH
...
class RobotEnv(mujoco_env.MujocoEnv):
    ...
    def __init__(
        ...
        try:
            from mujoco_kitchen.adept_envs.utils.remote_viz import RemoteViz
